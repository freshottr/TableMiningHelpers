...
print 'execute query'
cur.execute("SELECT medline.id_ext,medline.text_title,map.pmcid FROM shared.articles_medline_2014 as medline inner join shared.map_pmcid_pmid as map on map.pmid=medline.id_ext where medline.publication_type in ('Clinical Trial','Clinical Trial, Phase I','Clinical Trial, Phase II','Clinical Trial, Phase III','Clinical Trial, Phase IV','Controlled Clinical Trial','Randomized Controlled Trial','Clinical Conference')")
